...
<form action="ControleurCategorie?action=modifier" id="formAddCategorie" method="post" onsubmit="return valider();">
...
%>
  ...
  function initialisationLabel(id){
    ...
    Categorie c= new Loader().getCategorie(id1);
    %>
    ...
    for (var i = 0 ; i< arraySport.length; i++)
    {
      ...
      if (arraySport[i].idSport.toString() == "<%=c.getIdSport().toString()%>")
      {
